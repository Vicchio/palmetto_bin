...
# Weekend project: Search for the last iteration in each electronic relaxation 
# 
# So part of the problem is determining when the last energy step was determined.
# Looking at the '-----------Iteration ## ( ##) ------' line I should be able to 
# store the difference in energy and use the information for later. However, this 
# is something to do for fun on the weekend rather than during the week. 
# 
